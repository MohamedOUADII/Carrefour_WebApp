			...
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Employe ID</label> <input type="text"
						value="" class="form-control" name="IdEmp" required="required">
				</fieldset>
				<fieldset class="form-group">
					<label>Employe Name</label> <input type="text"
						value="" class="form-control" name="EmpName" required="required">
				</fieldset>
				<fieldset class="form-group">
					<label>salaire</label> <input type="text"
						value="" class="form-control" name="salaire" required="required">
				</fieldset>
				<fieldset class="form-group">
					<label>Departement</label> 
                                        <select class="form-control" name="refDept">
